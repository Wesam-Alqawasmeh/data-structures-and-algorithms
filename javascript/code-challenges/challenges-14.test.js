...
const screenForNames = (arr) => {
  // Solution code here...
  let regex = /\b^(Mr.|Mrs.|Ms.|Dr.)\s[A-Za-z]*\b/;
...
let biggerThanLuke = (arr) => {
  ...
  let newArr = [];
  arr.map((item) => {
    if (parseInt(item.mass) > lukeMass) {
...
const detectTicTacToeWin = (board) => {
  // Solution code here...
  // let c1r1, c1r2, c1r3, c2r1, c2r2, c2r3, c3r1, c3r2, c3r3
  let newArr = [];
  ...
  let [r1c1, r1c2, r1c3, r2c1, r2c2, r2c3, r3c1, r3c2, r3c3] = newArr;
